...
public class IEWS {
	public static XML getIE(String iePid, String rosettaInstance) throws Exception {
		final String rosettaURL = Customs.getRosettaURL(rosettaInstance);
		final String institution = Customs.getInstitution(rosettaInstance);
		final String userName = Customs.getUsername(rosettaInstance);
		final String password = Customs.getPassword(rosettaInstance);
		final String IE_WSDL_URL = Customs.getIE_WSDL_URL(rosettaURL);
